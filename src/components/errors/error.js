...
return(
        <div className='text-center position-relative p-5 my-4'>
            ...
            <button id="allBlueBtn" className=' btn btn-medium btn-rounded px-4 d-block mx-auto mt-4' style={{ backgroundColor: "#2b59b4", color: "white" }} onClick={reDirect}>Redirect to Home</button>
        </div>
    )
}
