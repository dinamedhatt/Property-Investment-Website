  ...
  return (
    <div>
      ...
      <div style={{backgroundColor:"#F3F3F4"}} className='row col-8 offset-2 mb-5'>
          <img src='images/about.png' alt='about' className='col-4'/>
          <div className='col-8 py-5 px-4'>
      ...
      <div className='row col-8 offset-2 mb-5 pb-5'>
          <div className='bg-white rounded shadow col-5 p-4'>
          ...
          <div className='bg-white rounded shadow col-6 offset-1 p-4'>
