...
const Home = () => {
    return (<div id="cover"  className="row col-12">
<div id="coverimg" className="img-fluid   relative">
    ...
    <div id="animatio-one" 
        className="col-sm-3 row bg-white col-3  col-md-3 col-lg-3 rounded shadow  px-md-2 p-md-1 px-0 p-0 p-lg-0"
        style={{
          height: "fit-content",
          position: "absolute",
          top:"45%",
